 ...
 * To encapsulate an entry or key-value pair you can use KeyValue<K,V> template class from 'include/keyvalue.h'.
 * To encapsulate a Node for the Linked List you can use Node<K,V> template class from 'include/node.h'.
 * Collection is another ADT, however, an implementation of Collection ADT as an template has been given in 'include/collection.h'.
